from EXPERIMENTS.generate_preds_visualizations.objects.predictor_custom import COCO_predictor
from EXPERIMENTS.generate_preds_visualizations.objects.CustomTextBox import ExtendedTextBox
from matplotlib.path import Path
from matplotlib.patches import BoxStyle
from EXPERIMENTS.generate_preds_visualizations.utils.util_functions import Utilities_helper as ut
...
class Model_single(object):
    ...
    def load_model(self):
        self.model_predictor = COCO_predictor(cfg=self.cfg,\
                                         model=self.model,
    ...
    def gather_images(self):
        ...
        print("Gathered images for model!")
    ...
    def run_pred_on_all_images(self):
        ...
        for img in images:
            ...
            try:
                ...
                fig.suptitle('Dataset {} | Model {}'.format(self.cfg.DATASETS.TEST[0],
                                                           self.cfg.MODEL.SEQUENCE + "_" + self.cfg.MODEL.SPECIFIC_SEQUENCE))
