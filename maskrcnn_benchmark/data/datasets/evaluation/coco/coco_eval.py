...
def do_coco_evaluation(
    ...
    dataset.coco.createIndex(use_ext=False)
...
def evaluate_predictions_on_coco(
    ...
    coco_dt = coco_gt.loadRes(str(json_result_file), use_ext=False) if coco_results else COCO()

    # coco_dt = coco_gt.loadRes(coco_results)
    coco_eval = COCOeval(coco_gt, coco_dt, iou_type, use_ext=False)
    coco_eval.evaluate()
