#ORIGINAL TRAINING SCRIPT => Doesn't work
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="/home/projects/bagon/andreyg/Projects/Variable_Resolution/Programming/maskrcnn_combined/configs/e2e_mask_rcnn_R_101_FPN_1x.yaml",
        metavar="FILE",
