...
from sanity_checking.bin_eval_per_obj_type_ann_norm_small_med.objects.recycler_obj import recyclerObj
from sanity_checking.bin_eval_per_obj_type_ann_norm_small_med.objects.annotation_processor_obj import annotationProcessor
from sanity_checking.bin_eval_per_obj_type_ann_norm_small_med.objects.misk_annotation_processor_obj import miskAnnotationProcessor
from sanity_checking.bin_eval_per_obj_type_ann_norm_small_med.objects.prediction_processor_obj import predictionProcessor
from sanity_checking.bin_eval_per_obj_type_ann_norm_small_med.objects.tester_obj import testerObj
...
class trialRunnerObj:
    ...
    def __init__(self, model_name,
        ...
        self.perform_annotation_norm = perform_annotation_norm
        ...
        for lower_threshold, upper_threshold,\
            ...
            if not os.path.exists(gen_prediction_file_path):
                prediction_processor_object = predictionProcessor(
                    ...
                    utils_helper = self.utils_helper,
                    mask_logit_threshold = 0.5 if trialRunnerObj._FILTER_MASK_LOGITS else 0.0,
                    summary_file_name = trialRunnerObj._GENERATED_PREDICTION_FILES_SUMMARIES)
