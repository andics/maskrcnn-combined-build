...
class Utilities_helper(object):
    ...
    def list_all_files_w_ext_in_a_parent_folder_recursively(self, parent_folder, extensions):
        """The following scripts lists all files with a
         given extension under a mina parent directory
         :param parent_folder String
         :param extensions List"""
        return [os.path.join(r, fn)
                for r, ds, fs in os.walk(parent_folder)
