...
class Utilities_helper(object):
    ...
    def display_multi_image_collage(self, images_info_bundle, plot_size):
        '''
        :param images_info_bundle: Expected to be a Tuple of Tuples, each sub-tuple containing the Title of the image
        and the image itself (in cv2 format)
        :param plot_size: contains number of rows [0] and number of columns [0]
        :return: None
        '''
